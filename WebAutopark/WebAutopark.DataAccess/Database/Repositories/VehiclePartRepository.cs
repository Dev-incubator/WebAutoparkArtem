...
namespace WebAutopark.DataAccess.Database.Repositories
{
    public class VehiclePartRepository : RepositoryConnection, IRepository<VehiclePart>
    {
        ...
        public async Task CreateAsync(VehiclePart entity)
        {
        ...
        public Task<IEnumerable<VehiclePart>> GetAllAsync()
        {
        ...
        public Task<VehiclePart> GetByIdAsync(int id)
        {
        ...
        public Task UpdateAsync(VehiclePart entity)
        {
            const string sqlQuery =
                "UPDATE VehicleParts " +
